    ...
    init(){
        ...
        if(!storage_str){
            ...
            for(let key in storage_obj){
               ...
               let str = `
                    <li style="width: 36px; height: 33px; line-height: 33px;">${good.id}</li>
                    <li style="width: 554px; height: 33px; line-height: 33px;">${good.name}</li>
                    <li style="width: 70px; height: 33px; line-height: 33px;">${good.price}</li>
                    ...
                    <li class="total" style="width: 90px; height: 33px; line-height: 33px;">${good.price * good.num}</li>
